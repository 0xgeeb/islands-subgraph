...
export class AmmFeeRecipient extends ethereum.Event {
  get params(): AmmFeeRecipient__Params {
    return new AmmFeeRecipient__Params(this);
  }
}

export class AmmFeeRecipient__Params {
  _event: AmmFeeRecipient;

  constructor(event: AmmFeeRecipient) {
    this._event = event;
  }
...
export class SetAuxTwapPeriod extends ethereum.Event {
  get params(): SetAuxTwapPeriod__Params {
    return new SetAuxTwapPeriod__Params(this);
  }
}

export class SetAuxTwapPeriod__Params {
  _event: SetAuxTwapPeriod;

  constructor(event: SetAuxTwapPeriod) {
    this._event = event;
  }
...
export class ICHIVault__collectFeesResult {
  value0: BigInt;
  value1: BigInt;
...
export class ICHIVault extends ethereum.SmartContract {
  ...
  try_ammFeeRecipient(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "ammFeeRecipient",
      "ammFeeRecipient():(address)",
      []
  ...
  auxTwapPeriod(): BigInt {
    let result = super.call("auxTwapPeriod", "auxTwapPeriod():(uint32)", []);

    return result[0].toBigInt();
  }

  try_auxTwapPeriod(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("auxTwapPeriod", "auxTwapPeriod():(uint32)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  collectFees(): ICHIVault__collectFeesResult {
    let result = super.call(
      "collectFees",
    ...
    return new ICHIVault__collectFeesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_collectFees(): ethereum.CallResult<ICHIVault__collectFeesResult> {
    let result = super.tryCall(
      "collectFees",
      "collectFees():(uint256,uint256)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new ICHIVault__collectFeesResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
...
export class SetAmmFeeRecipientCall extends ethereum.Call {
  get inputs(): SetAmmFeeRecipientCall__Inputs {
    return new SetAmmFeeRecipientCall__Inputs(this);
  }

  get outputs(): SetAmmFeeRecipientCall__Outputs {
    return new SetAmmFeeRecipientCall__Outputs(this);
  }
}

export class SetAmmFeeRecipientCall__Inputs {
  _call: SetAmmFeeRecipientCall;

  constructor(call: SetAmmFeeRecipientCall) {
    this._call = call;
  }

  get _ammFeeRecipient(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetAmmFeeRecipientCall__Outputs {
  _call: SetAmmFeeRecipientCall;
...
export class SetAuxTwapPeriodCall extends ethereum.Call {
  get inputs(): SetAuxTwapPeriodCall__Inputs {
    return new SetAuxTwapPeriodCall__Inputs(this);
  }

  get outputs(): SetAuxTwapPeriodCall__Outputs {
    return new SetAuxTwapPeriodCall__Outputs(this);
  }
}

export class SetAuxTwapPeriodCall__Inputs {
  _call: SetAuxTwapPeriodCall;

  constructor(call: SetAuxTwapPeriodCall) {
    this._call = call;
  }
...
export class SetAuxTwapPeriodCall__Outputs {
  _call: SetAuxTwapPeriodCall;

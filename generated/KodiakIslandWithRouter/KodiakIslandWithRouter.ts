...
export class KodiakIslandWithRouter__burnResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class KodiakIslandWithRouter__getMintAmountsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class KodiakIslandWithRouter__getUnderlyingBalancesResult {
  value0: BigInt;
  value1: BigInt;
...
export class KodiakIslandWithRouter__getUnderlyingBalancesAtPriceResult {
  value0: BigInt;
  value1: BigInt;
...
export class KodiakIslandWithRouter__mintResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class KodiakIslandWithRouter extends ethereum.SmartContract {
  static bind(address: Address): KodiakIslandWithRouter {
    return new KodiakIslandWithRouter("KodiakIslandWithRouter", address);
  }
  ...
  burn(
    burnAmount: BigInt,
    receiver: Address
  ): KodiakIslandWithRouter__burnResult {
    let result = super.call(
      "burn",
    ...
    return new KodiakIslandWithRouter__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_burn(
    burnAmount: BigInt,
    receiver: Address
  ): ethereum.CallResult<KodiakIslandWithRouter__burnResult> {
    let result = super.tryCall(
      "burn",
      "burn(uint256,address):(uint256,uint256,uint128)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new KodiakIslandWithRouter__burnResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getAvgPrice(interval: BigInt): BigInt {
    let result = super.call("getAvgPrice", "getAvgPrice(uint32):(uint160)", [
  ...
  try_getAvgPrice(interval: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("getAvgPrice", "getAvgPrice(uint32):(uint160)", [
      ethereum.Value.fromUnsignedBigInt(interval)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  getMintAmounts(
    amount0Max: BigInt,
    amount1Max: BigInt
  ): KodiakIslandWithRouter__getMintAmountsResult {
    let result = super.call(
      "getMintAmounts",
    ...
    return new KodiakIslandWithRouter__getMintAmountsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getMintAmounts(
    amount0Max: BigInt,
    amount1Max: BigInt
  ): ethereum.CallResult<KodiakIslandWithRouter__getMintAmountsResult> {
    let result = super.tryCall(
      "getMintAmounts",
      "getMintAmounts(uint256,uint256):(uint256,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new KodiakIslandWithRouter__getMintAmountsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getUnderlyingBalances(): KodiakIslandWithRouter__getUnderlyingBalancesResult {
    let result = super.call(
    ...
    return new KodiakIslandWithRouter__getUnderlyingBalancesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getUnderlyingBalances(): ethereum.CallResult<
    KodiakIslandWithRouter__getUnderlyingBalancesResult
  > {
    let result = super.tryCall(
      "getUnderlyingBalances",
      "getUnderlyingBalances():(uint256,uint256)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new KodiakIslandWithRouter__getUnderlyingBalancesResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getUnderlyingBalancesAtPrice(
    sqrtRatioX96: BigInt
  ): KodiakIslandWithRouter__getUnderlyingBalancesAtPriceResult {
    let result = super.call(
      "getUnderlyingBalancesAtPrice",
    ...
    return new KodiakIslandWithRouter__getUnderlyingBalancesAtPriceResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new KodiakIslandWithRouter__getUnderlyingBalancesAtPriceResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  isManaged(): boolean {
    let result = super.call("isManaged", "isManaged():(bool)", []);

    return result[0].toBoolean();
  }

  try_isManaged(): ethereum.CallResult<boolean> {
    let result = super.tryCall("isManaged", "isManaged():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  islandFactory(): Address {
    let result = super.call("islandFactory", "islandFactory():(address)", []);
  ...
  mint(
    mintAmount: BigInt,
    receiver: Address
  ): KodiakIslandWithRouter__mintResult {
    let result = super.call(
      "mint",
    ...
    return new KodiakIslandWithRouter__mintResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_mint(
    mintAmount: BigInt,
    receiver: Address
  ): ethereum.CallResult<KodiakIslandWithRouter__mintResult> {
    let result = super.tryCall(
      "mint",
      "mint(uint256,address):(uint256,uint256,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new KodiakIslandWithRouter__mintResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  pauser(param0: Address): boolean {
    let result = super.call("pauser", "pauser(address):(bool)", [
  ...
  try_pauser(param0: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall("pauser", "pauser(address):(bool)", [
      ethereum.Value.fromAddress(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  restrictedMint(): boolean {
    let result = super.call("restrictedMint", "restrictedMint():(bool)", []);

    return result[0].toBoolean();
  }

  try_restrictedMint(): ethereum.CallResult<boolean> {
    let result = super.tryCall("restrictedMint", "restrictedMint():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  swapRouter(param0: Address): boolean {
    let result = super.call("swapRouter", "swapRouter(address):(bool)", [
      ethereum.Value.fromAddress(param0)
    ]);
  ...
  try_swapRouter(param0: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall("swapRouter", "swapRouter(address):(bool)", [
      ethereum.Value.fromAddress(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
